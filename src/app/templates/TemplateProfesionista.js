...
const navigation = [
    
    {
        ...
        href: '/user/inicio/terapista/citas',
        icon: CalendarDaysIcon,
    },
    {
        name: 'Chats',
        description: 'Comunícate con tu terapeuta a través del chat.',
        href: '/user/inicio/terapista/chats',
...
const minmenu = [
    {
        ...
        href: '/user/inicio/terapista/perfil',
        icon: UserCircleIcon,
    },
    {
        name: 'Cerrar Sesión',
...
const TemplateProfesionista = ({ children }) => {
        ...
        <>
            ...
            <div className="fixed top-0 right-0 w-full h-full overflow-y-auto">
                <div className="relative min-h-full flex flex-col">
                                ...
                                <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                                    <div className="relative flex items-center justify-between h-16">
                                        <div className="flex items-center px-2 lg:px-0 xl:w-64">
                                            <a href="/user/inicio/terapista" className="cursor-pointer">
                                                <Image
                                                    width={240}
                                                    height={40}
                                                    src="/logo2.png"
                    ...
                    <div className="grid grid-cols-8 gap-4 w-full mx-auto">
...
export default TemplateProfesionista;
